...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://www.facebook.com/Termuxlover111"])
	exit(" [*] FACEBOOK :  https://www.facebook.com/Termuxlover111")
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/TAHIDUL-123/Aprooval.txt/blob/main/Aprooval.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            TAHIDUL KHAN
     \033[1;91m➣ \033[1;92mFACEBOOK   :            Termux Lover
     \033[1;93m➣ \033[1;92mWHATSAPP   :            01403380158
     \033[1;96m➣ \033[1;92mGITHUB     :            TAHIDUL-143
